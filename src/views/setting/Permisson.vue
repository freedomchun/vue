<template>
    <section>
        ...
        <!--新增界面-->
        <el-dialog title="新增权限" v-model="showAddPermission" :close-on-click-modal="false" size="tiny">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click.native.prevent="submitAddPermission" :loading="addLoading">提交
                </el-button>
            </div>
        </el-dialog>

        <!--修改界面-->
        <el-dialog title="修改权限" :visible.sync="showEditPermission" :close-on-click-modal="false" size="tiny">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click.native.prevent="submitEditPermission" :loading="editLoading">提交
                </el-button>
            </div>
        </el-dialog>
    </section>
