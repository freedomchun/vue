	...
	<section>
		<div class="grid-content bg-g">
			<el-form inline style="padding-top: 20px; padding-left: 20px;">
				...
				<el-form-item>
					<router-link :to="{name:'scenicManageAdd'}" class="addmain">新建景点</router-link>
				</el-form-item>
			</el-form>
		</div>
		<div>
		...
		<el-table :data="psList" border style="width: 100%; margin-top: 20px;">
			<el-table-column prop="cover" label="酒店封面" width="150"></el-table-column>
			<el-table-column prop="foodname" label="酒店名称"></el-table-column>
